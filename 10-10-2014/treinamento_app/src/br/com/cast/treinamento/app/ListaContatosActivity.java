...
public class ListaContatosActivity extends LifeCicleActivity {
	...
	protected static final int REQUET_CODE_INCLUIR_EDITAR = 1;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == REQUET_CODE_INCLUIR_EDITAR) {
			if (resultCode == 1) {
				Toast.makeText(this, R.string.toast_contato_salvo, Toast.LENGTH_SHORT).show();
			} else if(resultCode == 2) {
				Toast.makeText(this, R.string.contato_alterado, Toast.LENGTH_SHORT).show();
			}else{
				Toast.makeText(this, R.string.toast_registro_cancelado, Toast.LENGTH_SHORT).show();
			}
		}
	}
	...
	private void executarAcaoMenuSelecionado(int id) {
		...
		case R.id.action_novo:
			...
			startActivityForResult(intentIncluir, REQUET_CODE_INCLUIR_EDITAR);
			break;
		case R.id.action_editar:
			...
			startActivityForResult(intentEditar, REQUET_CODE_INCLUIR_EDITAR);
			break;
